...
const Home = () => {
  ...
  return (
    <div className="flex flex-col h-screen justify-between">
      <div>
        <p className="my-4 bg-green-50 text-green-600 py-1.5 rounded">
        ...
        <div className="mb-6 mt-4">
          ...
          <div className="flex items-center justify-center space-x-4">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-gray-700 text-gray-200 inline-block my-3 px-6 py-2 border-2 border-gray-600 rounded shadow-2xl sm:text-lg hover:bg-white hover:text-gray-600 transition duration-300"
            >
